  ...
  <body>
    <aside>
      ...
      <nav>
        ...
        <a href="recenzent-nastaveni.php" class="active">⚙️ Nastavení</a>
      </nav>
    </aside>
    ...
    <div style="flex: 1; display: flex; flex-direction: column">
      ...
      <main>
        <div class="card">
          <h2>👤 Profil recenzenta</h2>

          <label>Jméno</label>
          <input type="text" value="Iryna Rusa" />

          <label>E-mail</label>
          <input type="email" value="recenzent1@vspj.cz" />

          <label>Odborné zaměření</label>
          <input type="text" value="Regionální kuchyně a gastronomie" />
